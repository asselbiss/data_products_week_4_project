  ...
  navbarPage(
    ...
    tabPanel(
      ...
      sidebarPanel(
        ...
        sliderInput("hp", "Horsepower", min = minHp, max = maxHp, value = defaultCar$hp, step = 1),
    ...
    tabPanel(
      ...
      h3("Author: Assel Bissembay - August 25, 2017"),
      ...
      p("Source code of this application is available at",
        a(href = "https://github.com/asselbiss/data_products_week_4_project",
          "https://github.com/asselbiss/data_products_week_4_project")
      )
